...
with gr.Blocks(theme = gr.themes.Glass()) as dashboard:
    ...
    with gr.Row():
        user_query = gr.Textbox(label="Please enter a description of your book:", placeholder="e.g., A story about forgiveness")

        category_dropdown = gr.Dropdown(label="Category:", value="All", choices=categories)
        tone_dropdown = gr.Dropdown(label="Tone:", value="All", choices=tones)
        submit_button = gr.Button("Find recommendations")

    gr.Markdown("## Recommendations")
    output = gr.Gallery(label="Recommented books", columns=8, rows=2)
